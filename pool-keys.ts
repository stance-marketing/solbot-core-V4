...
const quote = new PublicKey(swapConfig.WSOL_ADDRESS);
const commitment = "confirmed";

  try {
    const baseAccounts = await connection.getProgramAccounts(new PublicKey(swapConfig.RAYDIUM_LIQUIDITY_POOL_V4_ADDRESS), {
      commitment,
      filters: [
    ...
    const quoteAccounts = await connection.getProgramAccounts(new PublicKey(swapConfig.RAYDIUM_LIQUIDITY_POOL_V4_ADDRESS), {
      commitment,
      filters: [
        { dataSize: LIQUIDITY_STATE_LAYOUT_V4.span },
        {
